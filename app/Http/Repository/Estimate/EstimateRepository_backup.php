...
class EstimateRepository
{
    ...
    public static function AddEstimate($request)
    {
        ...
        if ($estimate && $estimateService) {
            ...
            $message = "Hi " . $customer->first_name . " " . $customer->last_name . "! An estimate for your car repair has been created. You can preview and approve [insert link]. Let us know if you have any questions.                                       " . $customer->company_name . ".";
    ...
    public static function estimateAttchPdfTempate($estimate, $customer)
    {
        ...
        <body style="font-family: Roboto, sans-serif; padding: 24px; background-color: #FFFFFF;">
          <div style="border: 1px solid #eaeaea; padding: 32px !important; display: block; border-radius: 29px; box-shadow: 0px 0px 20px #d2d2d2a8; width: 70%; margin: 0 auto;">
            <table style="width: 100%; border-collapse: separate; border-spacing: 10px;">
              <tr>
                <td style="width: 50%;">
                  <img src="https://www.almysapp.com/assets/errors/logo/logo.jpg" alt="Brand Logo" style="width: 40%;">
                </td>
                <td style="width: 50%; text-align: right;">
                    <p style="font-size: 16px; font-weight: 500; margin-top: 5px;">Quote # <span> ' . htmlspecialchars($estimate->registration) . '</span></p>
                </td>
              </tr>
        
        
              <tr>
                  <th style="text-align:left;font-weight: 500;"><p style="font-size: 17px; margin: 0px; line-height: 1.43; margin-top: 30px;">Due date</p></th>
                 
                  <th style="text-align:left; font-weight: 500;"><p style="font-size: 17px; margin: 0px; line-height: 1.43; margin-top: 30px;">Number</p></th>
              </tr>
              <tr>
                  <td><p style="font-size: 16px; line-height: 1.43; margin: 0px; color: #111927;">' . date('d-m-Y', strtotime($estimate->created_at)) . '</p></td>
                  <td><p style="font-size: 16px; width:max-content; line-height: 1.43; margin: 0px; color: #111927">' . $customer->phone . '</p></td>
              </tr>
            </table>
             ...
             <table style="width: 100%; border-collapse: separate; border-spacing: 10px;">
              <tr>
                <th style="text-align: left; font-weight: 500; font-size: 17px; line-height: 1.43; background: #F5F7FA; padding: 16px; border-radius: 12px 12px 0 0; width: 33.33%;">Quote from</th>
                <th style="text-align: left; font-weight: 500; font-size: 17px; line-height: 1.43; background: #F5F7FA; padding: 16px; border-radius: 12px 12px 0 0; width: 33.33%;">Customer</th>
              </tr>
              <tr>
                <td style="padding: 16px; font-size: 16px; line-height: 1.43; color: #404C58; background: #FFF; border-radius: 8px;">
        ...
        $htmlContent .= '
            ...
            <table style="width: 39%; border-collapse: collapse; margin-top: 32px; margin-left: auto;">
              <tbody>
                <tr>
                  <td colspan="5"></td>
                  <td style="text-align: right; padding: 15px; font-size: 17px; font-weight: 500;">Subtotal</td>
                  <td style="text-align: right; padding: 15px; font-size: 17px; font-weight: 400;">$'. number_format($estimate->grand_total ?? 0, 2) - number_format($estimate->net_vat ?? 0, 2).'</td>
                </tr>
                <tr>
                  <td colspan="5"></td>
                  <td style="text-align: right; padding: 15px; font-size: 17px; font-weight: 500;">Discount</td>
                  <td style="text-align: right; padding: 15px; font-size: 17px; font-weight: 400;">$'.  number_format($estimate->net_discount ?? 0, 2) .'</td>
                </tr>
                <tr>
                  <td colspan="5"></td>
                  <td style="text-align: right; padding: 15px; font-size: 17px; font-weight: 500;">Total</td>
                  <td style="text-align: right; padding: 15px; font-size: 20px; font-weight: 400;">$'. number_format($estimate->net_total ?? 0, 2) .' </td>
                </tr>
              </tbody>
            </table>
          ...
          <tr>
            <td><b style="font-size:18px; font-weight:500;">Thankyou!</b> for choosing almys auto</td>
          </tr>
        </table>
